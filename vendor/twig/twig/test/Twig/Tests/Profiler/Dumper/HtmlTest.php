...
└ <span style="background-color: #ffd">materialize_test.twig</span> <span style="color: #d44">%d.%dms/%d%</span>
  ...
  └ materialize_test.twig::macro(<span style="background-color: #ddf">foo</span>)
  └ <span style="background-color: #ffd">embedded.twig</span>
    └ <span style="background-color: #ffd">included.twig</span>
</pre>
EOF
